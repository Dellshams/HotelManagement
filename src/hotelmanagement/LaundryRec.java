 ...
 * @author Shams
 */
public class LaundryRec extends javax.swing.JFrame {

    /**
     * Creates new form LaundryRec
     */
    public LaundryRec() {
        initComponents();
         setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LaundryRec.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LaundryRec().setVisible(true);
            }
        });
    }

 ...
 * @author Shams
 */
public class RestaurantRec extends javax.swing.JFrame {

    /**
     * Creates new form RestaurantRec
     */
    public RestaurantRec() {
        initComponents();
        setResizable(false);
        try{ 
        Connection con;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RestaurantRec.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RestaurantRec().setVisible(true);
            }
        });
    }

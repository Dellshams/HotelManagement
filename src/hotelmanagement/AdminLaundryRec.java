 ...
 * @author Shams
 */
public class AdminLaundryRec extends javax.swing.JFrame {

    /**
     * Creates new form AdminLaundryRec
     */
    public AdminLaundryRec() {
        initComponents();
        setResizable(false);
        try{ 
        Connection con;
        ...
        con = DriverManager.getConnection(url, user, password);
            ...
            String query = "Select * from adminlaundry";
            ResultSet rs;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminLaundryRec.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminLaundryRec().setVisible(true);
            }
        });
    }

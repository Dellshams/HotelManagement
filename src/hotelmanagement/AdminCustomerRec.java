 ...
 * @author Shams
 */
public class AdminCustomerRec extends javax.swing.JFrame {

    /**
     * Creates new form AdminCustomerRec
     */
    public AdminCustomerRec() {
        initComponents();
        setResizable(false);
        try{ 
        Connection con;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminCustomerRec.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminCustomerRec().setVisible(true);
            }
        });
    }

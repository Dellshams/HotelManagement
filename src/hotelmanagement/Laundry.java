...
public class Laundry extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField2.setBounds(330, 70, 170, 30);
        ...
        jComboBox3.setBounds(330, 160, 250, 30);

        jComboBox1.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select", "Shirt", "Trousers", "Suit", "Blazers" }));
        ...
        jComboBox1.setBounds(330, 270, 250, 30);
        ...
        jTextField11.setBounds(330, 400, 140, 30);
        ...
        jButton1.setBounds(340, 470, 160, 40);

        jLabel1.setBackground(new java.awt.Color(141, 108, 92));
        jLabel1.setFont(new java.awt.Font("Algerian", 1, 24)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("BOOK Laundry SERVICES");
        jPanel2.add(jLabel1);
        jLabel1.setBounds(210, 10, 370, 40);

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Customer ID:");
        jPanel2.add(jLabel3);
        jLabel3.setBounds(70, 70, 170, 20);
        ...
        jButton2.setBounds(550, 70, 90, 30);

        jLabel9.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(255, 255, 255));
        jLabel9.setText("Room Number:");
        jPanel2.add(jLabel9);
        jLabel9.setBounds(70, 160, 190, 30);

        jLabel10.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(255, 255, 255));
        jLabel10.setText("Laundry Type:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
          String Cus_ID, Room_No, Laundry_Type, Total_Cost;
        Cus_ID = jTextField2.getText();
        Room_No = (String) jComboBox3.getSelectedItem();
        Laundry_Type = (String) jComboBox1.getSelectedItem();
        ...
        con = DriverManager.getConnection(url, user, password);
            ...
            String query="INSERT INTO Laundry(Cus_ID, Room_No, Laundry_Type, Total_Cost) "
                    + "VALUES('"+Cus_ID+"', '"+Room_No+"', '"+Laundry_Type+"', '"+Total_Cost+"');";
            stmt.executeUpdate(query);
            String query2="INSERT INTO AdminLaundry(Cus_ID, Room_No, Laundry_Type, Total_Cost) "
                    + "VALUES('"+Cus_ID+"', '"+Room_No+"', '"+Laundry_Type+"', '"+Total_Cost+"');";
            stmt.executeUpdate(query);   
        JOptionPane.showMessageDialog(this, "Your Laundry has been booked");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
         ...
         if(jComboBox1.getSelectedItem().equals("Shirt"))
         {
             jTextField11.setText(Integer.toString(Shirt));
             double st = Double.parseDouble(jTextField11.getText());
             st=(st );
             String total = String.format(("# %.2f"), st);
             jTextField11.setText(total);
        }
         if (jComboBox1.getSelectedItem().equals("Trousers"))
         {
             jTextField11.setText(Integer.toString(Trousers));
              double st = Double.parseDouble(jTextField11.getText());
            st=(st );
            String total = String.format(("# %.2f"), st);
            jTextField11.setText(total);
         ...
         if(jComboBox1.getSelectedItem().equals("Suit"))
         {
             jTextField11.setText(Integer.toString(Suit));
             double st = Double.parseDouble(jTextField11.getText());
             st=(st );
             String total = String.format(("# %.2f"), st);
             jTextField11.setText(total);
        }
         if(jComboBox1.getSelectedItem().equals("Blazers"))
         {
             jTextField11.setText(Integer.toString(Blazers));
             double st = Double.parseDouble(jTextField11.getText());
             st=(st );
             String total = String.format(("# %.2f"), st);
             jTextField11.setText(total);

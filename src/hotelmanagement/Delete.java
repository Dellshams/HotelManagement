...
public class Delete extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField.setBounds(230, 20, 280, 50);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ...
            Statement stmt = null;
            stmt = con.createStatement();
            //String query = "update Booking set FName = '"+FName+"', LName = '"+LName+"', Addr = '"+Addr+"', Phone = '"+Phone+"', Mail = '"+Mail+"', Lang = '"+Lang+"', RType = '"+RType+"', Rnum = '"+Rnum+"', Occu = '"+Occu+"', CIDate = '"+CIDate+"', CODate = '"+CODate+"', COPeriod = '"+COPeriod+"', Serve = '"+Serve+"'";
            String query = "delete from customer_table where Cus_ID =" + "'" + jTextField.getText() + "'" + "limit 1;";
